...
impl PatternRef {
    ...
    pub fn get_charset(&self) -> Option<&CharSetRef> {
        unsafe {
            ...
            let result =
                FcPatternGetCharSet(self.as_ptr(), b"charset\0".as_ptr().cast(), 0, &mut charset);
    ...
    pub fn get_matrix(&self) -> Option<FcMatrix> {
        unsafe {
            ...
            let result =
                FcPatternGetMatrix(self.as_ptr(), b"matrix\0".as_ptr().cast(), 0, &mut matrix);
